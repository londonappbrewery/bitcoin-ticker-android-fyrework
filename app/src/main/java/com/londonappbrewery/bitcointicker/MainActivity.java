...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner crypto_spinner = (Spinner) findViewById(R.id.crypto_spinner);
        ...
        crypto_spinner.setAdapter(cryptoAdapter);
        ...
        spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                currencyURL= (String) parent.getItemAtPosition(position);
                finalURL = BASE_URL + cryptoURL + currencyURL;
        ...
        crypto_spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                cryptoURL = (String) parent.getItemAtPosition(position);
                finalURL = BASE_URL + cryptoURL + currencyURL;
                Log.d("Bitcoin", "URL: " + finalURL);
                letsDoSomeNetworking(finalURL);
            }
